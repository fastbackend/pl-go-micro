...
// który jest gotowy do obsługi żądań HTTP dla Broker'a
func (app *Config) routes() http.Handler {
	...
	// Konfiguracja endpointa "/" za pomocą funkcji mux.Post(),
	// która używa funkcji Broker do obsługi żądań POST
	mux.Post("/", app.Broker)

	// Obsługa żądań dla wszystkich mikroserwisów
	// Dopiero funkcja HandleSubmission identyfikuje typ żądania
